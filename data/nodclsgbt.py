...
print(CROPSIZE)
pdframe = pd.read_csv('sbset0annot.csv',
...
preprocesspath = r'F:\wangmansheng\data_set\LUNA16\preprocess\subset0/'
savepath = r'F:\wangmansheng\data_set\LUNA16\cls\crop_v3/'
import os
import os.path
...
subset1path = r'F:\wangmansheng\data_set\LUNA16\subset0/'
testfnamelst = []
